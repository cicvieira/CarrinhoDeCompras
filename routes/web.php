...
Route::get('/pesquisar', 'PesquisaController@pesquisar')->name('home.pesquisa');
...
Route::group(['prefix' => 'admin'], function () {
    Route::get('produtos', 'Admin\ProdutoController@index')->middleware('is_admin')->name('admin.produtos');
    ...
    Route::get('cupons', 'Admin\CupomDescontoController@index')->middleware('is_admin')->name('admin.cupons');
